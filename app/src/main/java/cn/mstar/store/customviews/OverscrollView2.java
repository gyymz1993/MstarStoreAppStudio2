...
* Github https://github.com/Suvitruf/Android-sdk-examples/tree/master/OverscrollView
*
...
public class OverscrollView2 extends ScrollView {
    ...
    private void setAttr(Context ctx, AttributeSet attrs) {
        TypedArray a = ctx.obtainStyledAttributes(attrs,R.styleable.OverscrollView2);
        mOverscrollDistance = (int) a.getDimension(R.styleable.OverscrollView2_oslvMaxOverScrollDistance,    MAX_Y_OVERSCROLL_DISTANCE);
        mSlowEffect = a.getBoolean(R.styleable.OverscrollView2_oslvSlowEffect,    HAS_SLOW_EFFECT );
        mAnimationTime = a.getInteger(    R.styleable.OverscrollView2_oslvAnimationTime,ANIMATION_DURATION);
        mSlowCoefficient = a.getFloat(R.styleable.OverscrollView2_oslvSlowCoefficient,SLOW_COEFFICIENT);
        a.recycle();
    }
