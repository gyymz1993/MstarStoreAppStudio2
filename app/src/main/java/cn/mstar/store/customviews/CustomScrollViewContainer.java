 ...
 *
 */
public class CustomScrollViewContainer extends RelativeLayout {
	...
	public CustomScrollViewContainer(Context context) {
		super(context);
		init();
	}

	public CustomScrollViewContainer(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public CustomScrollViewContainer(Context context, AttributeSet attrs, int defStyle) {
