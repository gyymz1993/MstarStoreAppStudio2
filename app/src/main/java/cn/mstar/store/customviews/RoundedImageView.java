...
public class RoundedImageView extends ImageView {
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_border_width2, -1);
    ...
    mBorderColor = a.getColorStateList(R.styleable.RoundedImageView_border_color2);
