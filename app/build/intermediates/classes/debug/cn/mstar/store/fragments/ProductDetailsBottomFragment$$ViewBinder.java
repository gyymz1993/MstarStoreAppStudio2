...
public class ProductDetailsBottomFragment$$ViewBinder<T extends cn.mstar.store.fragments.ProductDetailsBottomFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558956, "field 'mViewpager'");
    target.mViewpager = finder.castView(view, 2131558956, "field 'mViewpager'");
    view = finder.findRequiredView(source, 2131558601, "field 'tabs'");
    target.tabs = finder.castView(view, 2131558601, "field 'tabs'");
    view = finder.findRequiredView(source, 2131558955, "field 'rel'");
    target.rel = finder.castView(view, 2131558955, "field 'rel'");
  }
