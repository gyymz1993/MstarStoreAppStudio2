...
public class MyFavoriteManagmentActivity$$ViewBinder<T extends cn.mstar.store.activity.MyFavoriteManagmentActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558631, "field 'lny_content'");
    target.lny_content = finder.castView(view, 2131558631, "field 'lny_content'");
    view = finder.findRequiredView(source, 2131559256, "method 'reloadData'");
