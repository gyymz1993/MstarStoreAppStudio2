...
public class PayingTransactionSuccessActivity$$ViewBinder<T extends cn.mstar.store.activity.PayingTransactionSuccessActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558650, "field 'tv_price'");
    target.tv_price = finder.castView(view, 2131558650, "field 'tv_price'");
    view = finder.findRequiredView(source, 2131558651, "method 'goToProductDetails'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131558652, "method 'goToHome'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
